...
- No full character cast (players' seated poses, spectators, distinct arbiter states like pointing/arguing — Phase 4's remaining scope), seed content (Phase 6), or post-processing/lightmap-baking polish (rest of Phase 2) yet — see `docs/HALL_SIM_PLAN.md` for the full sequencing.
